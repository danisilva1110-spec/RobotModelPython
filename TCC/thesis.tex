...
\usepackage{pdflscape} % para páginas em paisagem (landscape) com rotação automática no PDF
\usepackage{listings}
\usepackage{svg} % para incluir arquivos SVG; compilar com: pdflatex --shell-escape
\usepackage{hyperref}
...
%  \linenumbers % inserir numeração nas linhas do texto
  ...
  \include{ModelagemMatematica}
  \include{SimulacaoNumerica}
