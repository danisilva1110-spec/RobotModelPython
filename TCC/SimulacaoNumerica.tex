...
O LADRC (Linear Active Disturbance Rejection Control), proposto por Han (1995) \cite{han1995class} e formalizado em versão linear por Gao (2003) \cite{gao2003scaling}, é implementado de forma descentralizada — um ESO e uma lei de controle por junta, ignorando o acoplamento dinâmico \cite{huang2014active}. Para a junta $i$, a dinâmica nominal é reescrita como:
\begin{equation}
